...
def fill_price(side: str, mid: float, bid: float|None, ask: float|None,
               spread_bp: float, vol_bp: float, qty: float, l1_depth: float|None,
               mid_history: list[float], params: FillParams = FillParams()) -> float:
