...
COMMENTS = {
    ...
    "PROMOTION_METRIC": "Validation metric checked before promoting a model.",
    ...
    "TRAIN_DATA_GLOB": "Glob used to discover input CSV files within DATA_DIR.",
    ...
    "LOG_LEVEL": "Log level for the ml_service application.",
}
