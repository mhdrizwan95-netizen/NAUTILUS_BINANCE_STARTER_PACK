...
RISK_DEFAULTS: dict[str, Any] = {
    ...
    "BNB_TOPUP_THRESHOLD_USD": 10.0,
    "BNB_TOPUP_AMOUNT_USD": 50.0,
    "BNB_TOPUP_INTERVAL_SEC": 1800,  # 30 minutes
    "BNB_MIN_TOPUP_INTERVAL_SEC": 3600,  # 1 hour
}
...
MOMENTUM_15M_DEFAULTS: dict[str, Any] = {
    ...
    "MOMENTUM_15M_SYMBOL": "BTCUSDT.BINANCE",
    "MOMENTUM_15M_LOOKBACK_TICKS": 60,
    "MOMENTUM_15M_QUANTITY": 1.0,
    "MOMENTUM_15M_ALLOW_SHORTS": False,
