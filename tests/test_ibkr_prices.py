...
def test_ibkr_price_publisher_configuration():
    ...
    try:
        ...
        assert 'AAPL' in ibkr_prices.WATCHLIST, f"AAPL should be in configured watchlist, got {ibkr_prices.WATCHLIST}"
        assert 'MSFT' in ibkr_prices.WATCHLIST, f"MSFT should be in configured watchlist, got {ibkr_prices.WATCHLIST}"
        assert 'NVDA' in ibkr_prices.WATCHLIST, f"NVDA should be in configured watchlist, got {ibkr_prices.WATCHLIST}"
        assert 'TSLA' in ibkr_prices.WATCHLIST, f"TSLA should be in configured watchlist, got {ibkr_prices.WATCHLIST}"
        assert len(ibkr_prices.WATCHLIST) == 4, f"Should have 4 symbols, got {len(ibkr_prices.WATCHLIST)}: {ibkr_prices.WATCHLIST}"
