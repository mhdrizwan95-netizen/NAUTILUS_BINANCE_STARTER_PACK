...
from engine.strategy import on_tick, _MACross, _execute_strategy_signal, register_tick_listener
...
class TestStrategyOnTick:
    ...
    def test_symbol_qualification(self):
        ...
        from engine.strategy import _notify_listeners
    ...
    def test_btc_base_extraction(self, mock_metrics, mock_execute, mock_ma_push):
        ...
        mock_metrics.strategy_confidence.labels.assert_called_with(symbol="BTCUSDT", venue="BINANCE")
    ...
    def test_listeners_always_notified(self, mock_notify, mock_ma_push):
        ...
        mock_notify.assert_called_once_with("BTCUSDT.BINANCE", 50000.0, pytest.approx(time.time(), abs=1.0))
    ...
    def test_ma_cross_push_buy_signal(self):
        ...
        result = mac.push("TEST", 104.0)  # This makes fast = (103+104)/2 = 103.5, slow = (101+102+103+104)/4 = 102.5
        assert result == "BUY"
    ...
    def test_ma_cross_push_sell_signal(self):
        ...
        result = mac.push("TEST", 100.0)  # fast = 101.0, slow = (104+103+102+101)/4 = 102.5, so 101.0 < 102.5
        assert result == "SELL"
