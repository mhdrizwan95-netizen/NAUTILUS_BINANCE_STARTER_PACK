...
class TestParsing(unittest.TestCase):
    """Test parse_prometheus_text function with various Prometheus formats."""
...
class TestJsonHelpers(unittest.TestCase):
    """Test from_json helper for extracting values from nested JSON."""

    def test_flat_structure(self):
        """Test flat JSON structure."""
        obj = {"pnl_realized": 1234.56, "drift_score": 0.42}
        self.assertEqual(from_json(obj, "pnl_realized"), 1234.56)
        self.assertEqual(from_json(obj, "drift_score"), 0.42)
        self.assertEqual(from_json(obj, "missing_key"), 0.0)
    ...
    def test_invalid_inputs(self):
        ...
        self.assertEqual(from_json(None, "key"), 0.0)
        # Type ignore for testing invalid inputs (runtime behavior)
        self.assertEqual(from_json({}, "key"), 0.0)  # type: ignore
        self.assertEqual(from_json({"key": "not_number"}, "key"), 0.0)

    def test_custom_default(self):
        """Test custom default values."""
        self.assertEqual(from_json(None, "key", default=42.0), 42.0)
...
class TestFallbackShapes(unittest.TestCase):
    ...
    def test_ops_snapshot_shape(self):
        ...
        result = {
            "pnl_realized": from_json(metrics, "pnl_realized"),
            "pnl_unrealized": from_json(metrics, "pnl_unrealized"),
            "drift_score": from_json(metrics, "drift_score"),
            "policy_confidence": from_json(metrics, "policy_confidence"),
            "order_fill_ratio": from_json(metrics, "order_fill_ratio"),
            "venue_latency_ms": from_json(metrics, "venue_latency_ms"),
        }
        expected = {
            "pnl_realized": 1234.56,
            "pnl_unrealized": 78.90,
